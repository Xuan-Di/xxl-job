...
/**
 * 触发器参数
 *  triggerParam 是启动job的一组参数集，在admin 页面 启动任务时将初始化triggerParam
...
//    任务 id
    ...
    private String executorHandler; // 定时任务的  方法名称 JobHandler
    private String executorParams; // 任务参数
    private String executorBlockStrategy; // 阻塞处理策略
    private int executorTimeout; // 任务超时时间

    private long logId;  // 日志id
    private long logDateTime;// 任务触发时间

    private String glueType; // 运行模式  一般是  bean，
